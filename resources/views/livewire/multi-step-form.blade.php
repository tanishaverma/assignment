<div class="signin-card">
    <form id="myForm" action="#" method="post" wire:submit.prevent="register">
        {{-- STEP 1 --}}
        @if ($currentStep == 1)
            <div id="step-1" class="clientFrom step p-0" data-id='1'>
              <div class="text-center pt-5">
                <img src="{{ asset('public/images/register-assets/mocal-logo.svg')}}" />
              </div>
              <div class="modal-px-60 pt-5">
                <input
                  type="email"
                  placeholder="Enter Email Address"
                  class="input-style input-font-bold" wire:model="email"
                />
                ...
                <div class="d-flex mt-4">
                  ...
                  <input
                    ...
                    class="input-style input-font-bold ps-3" wire:model="phone"
                  />
                </div>
                ...
                <div class="text-center">
                  <button type="button" 
                    class="btn-purple-fill btn-width-sm mt-5 nextScreen next" wire:click="increaseStep()"
                  >
                    Get Started
                  </button>
                  <div class="or"></div>
              ...
              <div class="modal-content radius24">
                <div class="pt-5">
                  <div class="text-center border-btm">
                    <img src="{{ asset('public/images/signin-assets/mocal-logo.svg')}}" class="logo-sm" />
                  </div>
                  ...
                  <div class="modal-body pt-4 modal-px-60">
                    ...
                    <div class="mb-5" wire:ignore>
                      <textarea name="description" class="description" id="description" wire:model="description"> </textarea>
                    </div>   
        ...
        setup: function(editor) {
                editor.on('change', function(e) {
                  ...
                  <div class="text-center mt-5 pt-5 mb-5">
                    <button type="button" class="btn btn-white-fill prevScreen prev" wire:click="decreaseStep()">< Back</button>
                    <button type="button" class="btn btn-purple-fill nextScreen next" wire:click="increaseStep()"> Next </button>
                  </div>
                </div>
              </div>
            </div>
                        ...
                        <div class="col-lg-12">                          
                          ...
                          <div class="inputfiles">
                            <div class="fileUploadWrap">
                                <div>
                                    <img src="{{ asset('public/images/register-assets/upload-files.png')}}"
                                        alt="" class="DropIcon" />
                                    <input type="file" name="import_file" wire:model="cv">
                                </div>
